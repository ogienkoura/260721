...
function renderFile (string $rout)
{
    ...
    return $content . getDownloadLink($rout) . ' ' . textFileEdit($rout);
}
...
function textFileEdit (string $rout): string
{
    return "<a href='/l12-files/file-edit.php?rout={$rout}' class='btn btn-info mt-3'>Edit</a>";
}
